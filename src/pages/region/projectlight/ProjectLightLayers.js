...
export default class ProjectLightLayers extends React.Component {
            ...
            .then(([Query, QueryTask, LengthsParameters, FeatureLayer, MapImageLayer, Relationship, Expand]) => {
                ...
                //   };
                    ...
                    var cellSit = { // autocasts as new popupTemplate()
                        title: "Cell Sites  (Site ID {Site_ID})",
                        content: [
                            {
                                type: "fields",
                                fieldInfos: [
                    ...
                    var aggregation = { // autocasts as new popupTemplate()
                        title: "Aggregation  (Site ID {Site_ID})",
                        content: [
                            {
                                type: "fields",
                                fieldInfos: [
                    ...
                    let Phase = new FeatureLayer("http://103.31.82.102:6080/arcgis/rest/services/Projects/TP_Light/MapServer/6", {
                ...
                //  let   S20 = new FeatureLayer("http://103.31.82.102:6080/arcgis/rest/services/Projects/SouthRegion/MapServer/9", {
        
                //         //  outFields: ["*"],				//Cities Boundary
                //         title: 'Cities Boundary',
                //         popupTemplate: s20
                //     });
                //     map.add(S20);
                ...
                map.add(ProposedRoute);
                    ...
                    var TpNet = new FeatureLayer("http://103.31.82.102:6080/arcgis/rest/services/Projects/TP_Light/MapServer/5", {
        
                        //  outFields: ["*"],				//Tp Network
                        title: 'Tp Network',
                        visible: true,
                        popupTemplate: TpNetwork
        
                    });
                    map.add(TpNet); 
        
                    
                    var poles = new FeatureLayer("http://103.31.82.102:6080/arcgis/rest/services/Projects/TP_Light/MapServer/4", {
                    ...
                    var TP_joints = new FeatureLayer("http://103.31.82.102:6080/arcgis/rest/services/Projects/TP_Light/MapServer/2", {
                    ...
                    var HH = new FeatureLayer("http://103.31.82.102:6080/arcgis/rest/services/Projects/TP_Light/MapServer/3", {
        
                        //  outFields: ["*"],				//HandHoles
                        title: 'HandHoles',
                        visible: false,
                        popupTemplate: hanhole
                    ...
                    var cellSite = new FeatureLayer("http://103.31.82.102:6080/arcgis/rest/services/Projects/TP_Light/MapServer/1", {
                    ...
                    var aggre = new FeatureLayer("http://103.31.82.102:6080/arcgis/rest/services/Projects/TP_Light/MapServer/0", {
