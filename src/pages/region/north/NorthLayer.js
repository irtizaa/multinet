 ...
 */
              ...
              /*   view.when(function () {
                ...
                let rng = new FeatureLayer("http://103.31.82.102:6080/arcgis/rest/services/Projects/NorthRegion/MapServer/8", {
                ...
                let    L4 = new FeatureLayer("http://103.31.82.102:6080/arcgis/rest/services/Projects/NorthRegion/MapServer/6", {
                    // outFields: ["*"],
                ...
                let     L2 = new FeatureLayer("http://103.31.82.102:6080/arcgis/rest/services/Projects/NorthRegion/MapServer/5", {
                    // outFields: ["*"],
                ...
                let    L3 = new FeatureLayer("http://103.31.82.102:6080/arcgis/rest/services/Projects/NorthRegion/MapServer/4", {
                    outFields: ["*"],
                    title: 'Poles',
                    visible: false,
                    popupTemplate:{
                ...
                let L1 = new FeatureLayer("http://103.31.82.102:6080/arcgis/rest/services/Projects/NorthRegion/MapServer/0", {
                    outFields: ["*"],               //Nodes
                    title: 'Nodes',
                    popupTemplate:{
                        title: 'Nodes',
                ...
                let Joint = new FeatureLayer("http://103.31.82.102:6080/arcgis/rest/services/Projects/NorthRegion/MapServer/3", {
                    outFields: ["*"],               //joint
                    title: 'Joints',
                    visible: false,
                    popupTemplate: joint
                ...
                let HH = new FeatureLayer("http://103.31.82.102:6080/arcgis/rest/services/Projects/NorthRegion/MapServer/2", {
                    outFields: ["*"],               //HH
                    title: 'HandHole',
                    visible: false,
                    popupTemplate:{
                ...
                let Customer = new FeatureLayer("http://103.31.82.102:6080/arcgis/rest/services/Projects/NorthRegion/MapServer/1", {
                    outFields: ["*"],               //Customers
                    title: 'Customers',
                    visible: false,
                    popupTemplate:{
