...
export default class LongHaulWidget extends React.Component {
    ...
    componentDidMount() {
        ...
        loadModules(["esri/widgets/Search", "esri/layers/FeatureLayer", "esri/layers/MapImageLayer", 'esri/widgets/Expand',
            ...
            "esri/widgets/Home", "esri/widgets/Print",'esri/widgets/BasemapGallery'
        ])
            .then(([Search, FeatureLayer, MapImageLayer, Expand, LayerList, BasemapToggle, Locate, Graphic, GraphicsLayerm, Home,Print,BasemapGallery]) => {
