...
export default class CentralLayers extends React.Component {
    ...
    componentDidMount() {
        ...
        loadModules(["esri/layers/FeatureLayer", "esri/layers/GeoJSONLayer", "esri/layers/GroupLayer"
             ...
             //   map.add(node)
              ...
              //  map.add(Customers)      
                    ...
                    map.add(City)
                        ...
                        let L_Rings = new FeatureLayer("http://103.31.82.102:6080/arcgis/rest/services/Projects/CentralRegion/MapServer/8", {
                            outFields: ["*"],
                            title: 'Rings',
                            popupTemplate: {
                                title: "Rings",
            ...
            let L_Poles = new FeatureLayer("http://103.31.82.102:6080/arcgis/rest/services/Projects/CentralRegion/MapServer/3", {
                outFields: ["*"],
                title: 'Poles',
            ...
            let L_Nodes = new FeatureLayer("http://103.31.82.102:6080/arcgis/rest/services/Projects/CentralRegion/MapServer/0", {
                outFields: ["*"],
                title: 'Nodes',
                popupTemplate: { // autocasts as new PopupTemplate()
                    title: "Node",
           ...
           let L_Joints = new FeatureLayer("http://103.31.82.102:6080/arcgis/rest/services/Projects/CentralRegion/MapServer/4", {
            outFields: ["*"],
            title: 'Joints',
        ...
        map.add(L_Joints);
            ...
            let L_Handholes = new FeatureLayer("http://103.31.82.102:6080/arcgis/rest/services/Projects/CentralRegion/MapServer/2", {
            ...
            let L_Customers = new FeatureLayer("http://103.31.82.102:6080/arcgis/rest/services/Projects/CentralRegion/MapServer/1", {
                outFields: ["*"],           //Customers
                title: 'Customers',
                popupTemplate: {
                    title: "Customer",
